...
const Sidebar = ({ fetchBlogs }) => {
    ...
    return (
        <div className="sidebar">
            ...
            <ul>
                <li><Link to=""><span className='icon'><FaUser size={20}/></span> <span className='text'>Profile </span> </Link></li>
                ...
                <li><Link to=""><span className='icon'><FaHistory size={20}/></span> <span className='text'>Bookings</span></Link></li>
