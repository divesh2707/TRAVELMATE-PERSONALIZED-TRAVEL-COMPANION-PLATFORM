...
const CustomersHistoryFilter = ({ filters, onFilterChange, resetFilters, setIsFilterModalOpen }) => {
    ...
    <div className="booking-history-filters-container">
      ...
      <div className="booking-history-filter-group">
        ...
        <div className="booking-history-filter-options">
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="status" value="" checked={tempFilters.status === ""} onChange={handleChange} /> All</label>
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="status" value="To Be Visited" checked={tempFilters.status === "To Be Visited"} onChange={handleChange} /> To Be Visited</label>
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="status" value="Already Visited" checked={tempFilters.status === "Already Visited"} onChange={handleChange} /> Already Visited</label>
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="status" value="Cancelled" checked={tempFilters.status === "Cancelled"} onChange={handleChange} /> Cancelled</label>
        </div>
      </div>
      ...
      <div className="booking-history-filter-group">
        ...
        <div className="booking-history-filter-options">
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="customPackage" value="" checked={tempFilters.customPackage === ""} onChange={handleChange} /> All</label>
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="customPackage" value="Yes" checked={tempFilters.customPackage === "Yes"} onChange={handleChange} /> Customized</label>
          <label style={{cursor:"pointer"}}><input style={{cursor:"pointer"}} type="radio" name="customPackage" value="No" checked={tempFilters.customPackage === "No"} onChange={handleChange} /> Standard</label>
        </div>
      </div>
...
export default CustomersHistoryFilter;
