...
const AdminAccommodation = ({ getImageSrc, luxuryHotels }) => {
  ...
  if (!luxuryHotels?.hotel_category) {
    return null;
  }
      ...
      hotels.map((hotel, index) => (
        <div key={index} className="hotel-card">
          ...
          <div className="packagehoteltext">
            ...
            <p style={{marginTop:"10px", fontSize:"20px", fontWeight:"bold", }}>₹ {hotel.price_per_night}.00</p>
          </div>
        </div>
      ))
    ):(
