...
const AdminPopularPackageCard=(props)=>{
    ...
    const handleCardClick = () => {
        navigate(`/adminDashboard/packageDetails/${props.id}`); // Navigate to the package details page with the package ID
    };
...
export default AdminPopularPackageCard;
