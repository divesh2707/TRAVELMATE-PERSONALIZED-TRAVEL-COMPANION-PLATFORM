...
const CustomersHistoryCard = ({filters, user_id}) => {
    ...
    <div className="booking-history-container">
      {loading ? (
        ...
        filteredBookings.map((booking) => (
          <div key={booking.booking_id} className="booking-history-card" onClick={() => navigate(`/adminDashboard/BookingAndCustomers/CustomersHistory/${user_id}/PackageDetail/${booking.city_id}`,
...
export default CustomersHistoryCard;
